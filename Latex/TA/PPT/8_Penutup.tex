...
\begin{frame}{Bab 5.1 - Kesimpulan: Efektivitas Warm-Start Nash}
    \begin{itemize}
        \item \textbf{Akselerasi Konvergensi:} Penerapan \textit{Nash Equilibrium} sebagai inisialisasi \textit{warm-start} meningkatkan stabilitas konvergensi algoritma VQE secara signifikan.
