...
::: {.fragment .fade-in}
![](../Gambar/Markowitz_Foto.png){width="80%" style="border-radius: 10px; margin-bottom: 10px;"}
:::

::: {.fragment .fade-in}
![](../Gambar/Porto_selection.png){width="100%" style="border-radius: 10px;"}
:::
...
::: {.fragment .fade-in}
![](../Gambar/Mantegna_Foto.png){width="80%" style="border-radius: 10px; margin-bottom: 10px;"}
:::

::: {.fragment .fade-in}
![](../Gambar/intro_econophys.png){width="100%" style="border-radius: 10px;"}
:::
...
::: {.fragment .fade-in}
![](../Gambar/komputer_kuantum.png){width="100%" style="border-radius: 10px;"}
:::
