\contentsline {lstlisting}{\numberline {4.1}{\ignorespaces Skrip ekstraksi data harga historis saham menggunakan API \texttt {yfinance}}}{59}{lstlisting.4.1}%
...
\contentsline {lstlisting}{\numberline {4.9}{\ignorespaces Skrip kalkulasi fungsional matriks evaluasi observabel algoritma Entropi Von Neumann komputasional menggunakan matriks trace tereduksi arsitektur operasional pada ruang fase deterministik fungsi ekuilibrium}}{77}{lstlisting.4.9}%
