...
\vspace{4mm}
\textbf{OPTIMASI PORTOFOLIO BERBASIS MODEL MARKOWITZ MENGGUNAKAN \textit{VARIATIONAL QUANTUM EIGENSOLVER}} \\
\vspace{4mm}
\textbf{TUGAS AKHIR} \\
\vspace{4mm}
