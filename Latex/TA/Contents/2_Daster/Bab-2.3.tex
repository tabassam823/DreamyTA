...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Matriks imbal hasil pada model permainan klasik: (a) \textit{Stag Hunt}, (b) \textit{Prisoner's Dilemma}, dan (c) \textit{Battle of the Sexes} yang merepresentasikan variasi struktur ekuilibrium~\cite{szabo_evolutionary_2016}.}
    \label{fig:payoffs}
\end{figure}
