...
Salah satu Ansatz yang banyak digunakan dalam simulasi kimia kuantum adalah Klaster Tergandeng Uniter atau \textit{Unitary Coupled Cluster} (UCC). Ansatz ini dikembangkan dari metode klaster tergandeng atau \textit{Coupled Cluster} pada kimia komputasi dan dirancang untuk menangkap korelasi elektron secara sistematis. Keunggulan utama UCC adalah kemampuannya mempertahankan sifat uniter evolusi kuantum sehingga lebih sesuai untuk implementasi pada komputer kuantum dibandingkan formulasi Klaster Tergandeng konvensional. Keadaan kuantum pada Ansatz UCC dibangkitkan melalui operator uniter
\begin{equation}
    \label{eq:ucc_ansatz}
    \begin{split}
