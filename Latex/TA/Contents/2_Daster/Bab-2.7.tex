...
Salah satu HEA yang banyak digunakan dalam implementasi VQE adalah EfficientSU2. Ansatz ini dibangun dari kombinasi gerbang rotasi satu-qubit dan lapisan keterbelitan yang disusun secara berulang. Struktur tersebut memungkinkan eksplorasi ruang keadaan kuantum yang luas tanpa memerlukan jumlah gerbang yang terlalu besar. Untuk sistem yang terdiri atas $N$ qubit dan kedalaman sirkuit sebesar $L$, keadaan kuantum dapat dituliskan sebagai
\begin{equation}
\begin{split}
