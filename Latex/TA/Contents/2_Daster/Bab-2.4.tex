...
Untuk memastikan bahwa konfigurasi portofolio rasional selalu mematuhi batasan sistem yang mengharuskan pemilihan instrumen sebesar batasan $K$, maka diperlukan penambahan suku penalti kuadratik \cite{abdul_hali_markowitz_2020}. Komponen suku penalti disimbolkan sebagai $P(\mathbf{x})$ dilengkapi dengan pemberian faktor skalar pengali $A$ yang bertindak sangat dominan dalam menjustifikasi arsitektur komputasi kuantum. Konfigurasi perlakuan energi tersebut dimaksudkan untuk menekan nilai probabilitas eksistensi dari kombinasi susunan strategis yang nyata melanggar ketentuan rasio ketersediaan anggaran. Bentuk dari fungsi penalti kuadratik tersebut secara umum dapat dirumuskan sebagai
\begin{equation}
...
\begin{equation*}
    Q_{ii} = \frac{\gamma \sigma_{ii}}{2K^2}+A-\frac{\mu_i}{K}-2AK \quad \text{dan} \quad Q_{ij} = \frac{\gamma \sigma_{ij}}{2K^2}+A.
\end{equation*}
