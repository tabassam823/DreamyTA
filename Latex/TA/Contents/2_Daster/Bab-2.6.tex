...
Metode optimasi yang tepat memungkinkan sistem untuk mencapai konvergensi energi minimum meskipun beroperasi di tengah keterbatasan koherensi sirkuit~\cite{fontana_evaluating_2021}. Algoritma gradien klasik konvensional sering kali mengalami kendala teknis saat diterapkan langsung pada lanskap energi kuantum yang bergejolak akibat \textit{noise} pengukuran~\cite{sharma_noise_2020}. Ketidakstabilan numerik ini dapat diatasi dengan menerapkan teknik estimasi gradien yang mengeksploitasi properti analitis dari operator uniter tanpa memperburuk eror yang terjadi pada sistem~\cite{wierichs_general_2022}. Bab ini akan menguraikan implementasi teknis dari metode \textit{Parameter Shift Rule} dan optimasi stokastik \textit{SPSA} sebagai pilar utama dalam pembaruan parameter sirkuit secara efisien dan akurat.
