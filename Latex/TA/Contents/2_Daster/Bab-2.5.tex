...
Bab ini akan menguraikan bagaimana sistem qubit dapat menjadi fondasi utama teknis komputer kuantum lalu dilanjutkan dengan gerbang kuantum 1 qubit dan 2 qubit. Kemudian dikenalkan pula \textit{Quantum entanglement} sebagai akibat dari penggunaan gerbang kuantum dan \textit{Quantum Measurement} sebagai dasar pengukuran sistem kuantum di akhir rangkaian kuantum~\shortcite{coyle_quantum_2021}. Terakhir, \textit{Quantum Machine Learning} dan \textit{Parameterized Quantum Circuit} yang menjadi dasar dari algoritma VQE yang akan digunakan pada tugas akhir ini.
