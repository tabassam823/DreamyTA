...
\begin{frame}{Pendahuluan \& Latar Belakang}
    ...
    \vspace{0.5cm}
    \begin{center}
        \textit{[Visualisasi: Ilustrasi perbandingan grafik Risk vs Return]}
    \end{center}
\end{frame}
...
\begin{frame}{Mapping ke Hamiltonian Kuantum}
    \begin{itemize}
        	\item \textbf{Bagaimana komputer kuantum memahami masalah ini?}
...
\begin{frame}{Persiapan Data \& Studi Kasus}
    ...
    \vspace{0.5cm}
    \begin{center}
        \textit{[Visualisasi: Tabel Expected Returns dan Covariance Matrix]}
    \end{center}
\end{frame}
...
\begin{frame}{Hasil Optimasi}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \end{itemize}
            \vspace{1cm}
            \textit{[Placeholder Gambar Konvergensi]}
        \end{column}
        \begin{column}{0.5\textwidth}
            \textbf{Hasil Akhir}
            \begin{itemize}
...
\begin{frame}{Kesimpulan}
    \begin{itemize}
        	\item VQE berhasil mereplikasi pemilihan portofolio optimal yang mematuhi constraint.
        \item Demonstrasi potensi algoritma kuantum jangka pendek (NISQ) untuk masalah keuangan.
        \item \textbf{Langkah Selanjutnya:}
        \begin{itemize}
            	\item Meningkatkan jumlah aset.
            	\item Menguji pada \textit{Real quantum device}.
        \end{itemize}
    \end{itemize}
\end{frame}
