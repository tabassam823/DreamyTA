...
\begin{enumerate}
    \item asumsi bahwa pemain dalam sistem finansial adalah agen rasional yang berusaha memaksimalkan utilitasnya dalam kondisi ketidakpastian
    \item hubungan permaian dan fungsi potensial
    \item contoh nyata permainan potensial
    \item penurunan rumus fungsi potensial dari model mean-variance portfolio optimization
    \item Ekuivalensi Nash dan Ground State
    \item Hubungan Permainan Potensial dan Hamiltonian Ising
    \item Pemetaan Hamiltonian Ising dari Permainan Potensial
\end{enumerate}
