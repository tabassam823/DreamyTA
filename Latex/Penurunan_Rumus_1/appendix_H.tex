...
\textbf{Kesimpulan:} Aturan Born adalah jembatan terakhir yang mengubah \textbf{amplitudo kuantum yang tak terlihat} menjadi \textbf{distribusi data yang teramati}. Dalam konteks Markowitz, aturan inilah yang memungkinkan kita memilih aset investasi berdasarkan \emph{bitstring} yang memiliki probabilitas tertinggi di akhir algoritma VQE.
